...
**
** Created: Fri Mar 1 23:21:25 2013
...
static const char qt_meta_stringdata_XbelTree[] = {
    "XbelTree\0\0item,column\0"
    "updateDomElement(QTreeWidgetItem*,int)\0"
};

const QMetaObject XbelTree::staticMetaObject = {
    { &QTreeWidget::staticMetaObject, qt_meta_stringdata_XbelTree,
      qt_meta_data_XbelTree, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &XbelTree::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_XbelTree))
...
int XbelTree::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: updateDomElement((*reinterpret_cast< QTreeWidgetItem*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        _id -= 1;
    }
